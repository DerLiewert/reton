...
*/
        ...
        document.querySelectorAll("[data-tabs]").forEach((tabBlock => {
            ...
            if (activeTab) activeTab.style.removeProperty("display"); else tabBodies[0].style.removeProperty("display");
        ...
        awardsTabBlocks.forEach((awardsTabs => {
            ...
            awardsContent.addEventListener("touchstart", awardsContentTouchStart, {
                passive: true
            });
            ...
            awardsNavWrapper.addEventListener("touchstart", awardsNavTouchStart, {
                passive: true
            });
            ...
            function awardsNavTouchStart(e) {
                ...
                if (getWindowWidth() >= 768) awardsNavWrapper.addEventListener(moveEvent, awardsNavVerticalMove, {
                    passive: false
                }); else awardsNavWrapper.addEventListener(moveEvent, awardsNavHorisontalMove, {
                    passive: true
                });
                if (moveEvent === "mousemove") awardsNavWrapper.classList.add("unselectable");
            }
            function awardsContentTouchStart(e) {
                setStartPoints(e);
                if (getWindowWidth() >= 768) return;
                const moveEvent = e.type === "touchstart" ? "touchmove" : "mousemove";
                awardsContent.addEventListener(moveEvent, awardsContentHorisontalMove, {
                    passive: true
                });
            }
            function awardsNavTouchEnd(e) {
                ...
                if (getWindowWidth() >= 768) awardsNavWrapper.removeEventListener(moveEvent, awardsNavVerticalMove); else awardsNavWrapper.removeEventListener(moveEvent, awardsNavHorisontalMove);
                if (moveEvent === "mousemove") awardsNavWrapper.classList.remove("unselectable");
            }
            ...
            function onTabClick(e) {
                ...
                if (e.target !== activeTab) changeActiveTab(activeTab, e.target);
            }
            const breakpoints = {
                0: 1,
                480: 2,
            ...
            function onNext(setNextVisibleTabGroup = false) {
                ...
                if (setNextVisibleTabGroup) nextTabIndex = visibleTabIndex.last < tabTitles.length - showTabsCount ? visibleTabIndex.last + 1 : tabTitles.length - showTabsCount; else nextTabIndex = activeTabIndex + 1;
            ...
            function onPrev(setNextVisibleTabGroup = false) {
                ...
                if (setNextVisibleTabGroup) prevTabIndex = visibleTabIndex.first - 1 < showTabsCount ? showTabsCount - 1 : visibleTabIndex.first - 1; else prevTabIndex = activeTabIndex - 1;
